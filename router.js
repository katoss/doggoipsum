...
router.post('/', (request, response) => {
    request.on('data', function(inputValue) {
        ...
        let query = inputValue.toString(); // e.g. numberOfParagraphs=3
        // Parse the query into a key/value pair and store the value of +
        // numberOfParagraphs in a variable
...
// This export allows us to require the file inside of app.js
